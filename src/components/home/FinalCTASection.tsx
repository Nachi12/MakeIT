...
export const FinalCTASection: React.FC = () => {
  return (
    <section className="py-20 lg:py-28 bg-[#111827] text-white font-sans">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-8 max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            ...
            <Link href="/services">
              <button className="px-7 py-3.5 text-base font-bold rounded-full bg-transparent text-white border border-[#374151] hover:bg-[#1F2937] transition-colors cursor-pointer">
                EXPLORE SERVICES
              </button>
            </Link>
          </div>
