      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 space-y-14">
        ...
        <Reveal direction="up" distance={20}>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <Link href="/solutions" className="inline-flex items-center gap-2 text-xs font-bold text-[#111111] hover:text-[#F97316] transition-colors">
              ...
              <StaggerItem key={item.title}>
                <motion.div
                  ...
                  className={`py-6 px-4 sm:px-6 transition-all duration-200 cursor-pointer rounded-2xl ${
                    isSelected ? 'shadow-xs border border-[#E5E0D5]' : 'hover:bg-[#F7F3E8]'
                  }`}
                >
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="md:w-5/12 min-h-[50px] flex items-center">
                      <AnimatePresence mode="wait">
                        {isSelected ? (
                          ...
                          <motion.div 
                            ...
                            animate={{ opacity: 1 }}
                            exit={{ opacity: 0 }}
                            className="hidden md:block text-xs text-[#787870] font-medium italic"
                          >
